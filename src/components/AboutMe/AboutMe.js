        ...
        <div className='about-me__content'>
          <div className='about-me__info'>
            ...
            <p className='about-me__description'>
              Я живу в Санкт-Петербурге с 2016 года. Переехал для того, чтобы
              получить высшее образование. Закончил СПбПУ им. Петра Великого по
              специальности "Автоматизация технологических процессов и
              производств". Начал заниматься программированием с 2021 года и
              хочу связать свое будущее с ним. Люблю кофе, худи и котов, считай,
              готовый программист!
            </p>
